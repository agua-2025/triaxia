  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 text-slate-800 overflow-x-hidden relative">
      ...
      <section className="relative z-10 px-6 py-20 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-slate-600 mb-8 max-w-2xl mx-auto leading-relaxed">
            <strong>
              Ocupe sua equipe de RH com o que é realmente necessário.
            </strong>
            <br />
            Deixe a inteligência artificial processar milhares de currículos,
            fazer análises comportamentais e encontrar matches perfeitos
            automaticamente.
          </p>
          ...
          <div className="mt-8 flex justify-center items-center space-x-6 text-slate-500">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-sm font-medium">
                +847 empresas ativas hoje
              </span>
            </div>
            <div className="flex items-center space-x-2">
              <div className="w-3 h-3 bg-blue-500 rounded-full animate-pulse"></div>
              <span className="text-sm font-medium">
                +10.000 contratações realizadas
              </span>
            </div>
          </div>
        </div>
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-600 max-w-4xl mx-auto leading-relaxed">
              ...
              <strong className="text-purple-600">
                nós revolucionamos completamente a experiência
              </strong>{' '}
              de recrutamento
            </p>
          </div>
              ...
              <div className="bg-gradient-to-br from-green-50 to-emerald-50 border-2 border-green-200 rounded-2xl p-6 relative overflow-hidden shadow-lg">
                ...
                <ul className="space-y-3 text-slate-700">
                  <li className="flex items-start">
                    ...
                    <strong>Candidatura exclusiva:</strong> Zero concorrência
                    entre empresas
                  </li>
                  <li className="flex items-start">
                    <span className="text-green-500 mr-3 mt-1">✓</span>
                    <strong>Página dedicada:</strong> 100% customizável com sua
                    marca
                  </li>
                  <li className="flex items-start">
                    <span className="text-green-500 mr-3 mt-1">✓</span>
              ...
              <div className="relative bg-gradient-to-br from-white/90 to-purple-50/90 backdrop-blur-sm border border-purple-200 rounded-3xl p-8 shadow-2xl">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center p-3 bg-gradient-to-r from-pink-100 to-orange-100 rounded-xl">
                    ...
                    <span className="text-sm font-medium text-slate-700">
                      Candidatos focados apenas em você
                    </span>
                  </div>
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-300 max-w-3xl mx-auto">
              Veja como uma empresa de varejo revolucionou seu processo de
              recrutamento
            </p>
          </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center text-red-200">
                  ...
                  <span className="text-lg">
                    245 currículos para analisar manualmente
                  </span>
                </div>
                <div className="flex items-center text-red-200">
                  <span className="w-2 h-2 bg-red-400 rounded-full mr-3"></span>
                  <span className="text-lg">
                    12 dias de trabalho manual intensivo
                  </span>
                </div>
                <div className="flex items-center text-red-200">
                  <span className="w-2 h-2 bg-red-400 rounded-full mr-3"></span>
                  <span className="text-lg">
                    3 funcionários do RH dedicados full-time
                  </span>
                </div>
                <div className="flex items-center text-red-200">
                  <span className="w-2 h-2 bg-red-400 rounded-full mr-3"></span>
                  <span className="text-lg font-bold">
                    R$ 8.400 em custos operacionais
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-3xl p-8 backdrop-blur-sm">
              ...
              <div className="space-y-4">
                <div className="flex items-center text-emerald-200">
                  ...
                  <span className="text-lg">
                    245 currículos analisados em 3 minutos
                  </span>
                </div>
                <div className="flex items-center text-emerald-200">
                  <span className="w-2 h-2 bg-emerald-400 rounded-full mr-3"></span>
                  <span className="text-lg">
                    Top 15 candidatos identificados automaticamente
                  </span>
                </div>
                <div className="flex items-center text-emerald-200">
                  <span className="w-2 h-2 bg-emerald-400 rounded-full mr-3"></span>
                  <span className="text-lg">
                    RH focou apenas em entrevistas finais
                  </span>
                </div>
                <div className="flex items-center text-emerald-200">
                  <span className="w-2 h-2 bg-emerald-400 rounded-full mr-3"></span>
                  <span className="text-lg font-bold">
                    R$ 497 de custo total
                  </span>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 bg-gradient-to-r from-slate-800 to-slate-900 relative overflow-hidden">
        <div className="absolute inset-0 bg-[url('data:image/svg+xml,%3Csvg%20width%3D%2240%22%20height%3D%2240%22%20viewBox%3D%220%200%2040%2040%22%20xmlns%3D%22http://www.w3.org/2000/svg%22%3E%3Cg%20fill%3D%22%23ffffff%22%20fill-opacity%3D%220.05%22%3E%3Cpath%20d%3D%22M20%2020c0-5.5-4.5-10-10-10s-10%204.5-10%2010%204.5%2010%2010%2010%2010-4.5%2010-10zm10%200c0-5.5-4.5-10-10-10s-10%204.5-10%2010%204.5%2010%2010%2010%2010-4.5%2010-10z%22/%3E%3C/g%3E%3C/svg%3E')] opacity-20"></div>

        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          <div className="bg-gradient-to-br from-emerald-500/20 to-teal-500/20 backdrop-blur-sm rounded-3xl p-12 border border-emerald-400/30">
            <div className="flex justify-center mb-8">
              <div className="bg-emerald-500/20 rounded-full p-6 border border-emerald-400/30">
            ...
            <p className="text-2xl text-gray-100 mb-8 leading-relaxed">
              Se você não economizar pelo menos{' '}
              <strong className="text-emerald-300">20 horas de trabalho</strong>{' '}
              no primeiro mês,
            ...
            <div className="grid md:grid-cols-3 gap-8 mt-12">
              <div className="text-center">
                <div className="bg-emerald-500/20 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4 border border-emerald-400/30">
                  <span className="text-2xl">⚡</span>
                </div>
                <h3 className="text-xl font-bold text-white mb-2">
                  Sem Perguntas
                </h3>
                <p className="text-gray-200">Processo simples e direto</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-200">Reembolso em até 48h</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-200">Assumimos todo o risco</p>
              </div>
            </div>

            <div className="mt-12 p-6 bg-emerald-500/10 rounded-2xl border border-emerald-400/30">
              <p className="text-lg text-white font-semibold">
                💡 <strong>Por que oferecemos essa garantia?</strong>
                <br />
                <span className="text-gray-200 font-normal">
                  Porque sabemos que o Triaxia vai transformar seu RH. Mais de
                  2.847 empresas já comprovaram.
                </span>
              </p>
            </div>
          </div>
