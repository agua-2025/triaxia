...
async function checkJubsupermercadoTenant() {
  try {
    console.log('🔍 Verificando tenant "jubsupermercado"...');
    
    const tenant = await prisma.tenant.findUnique({
      where: { slug: 'jubsupermercado' },
      include: {
        users: true
      }
    });
    ...
    if (tenant) {
      console.log('✅ Tenant "jubsupermercado" encontrado:');
      ...
      console.log('❌ Tenant "jubsupermercado" NÃO foi encontrado!');
